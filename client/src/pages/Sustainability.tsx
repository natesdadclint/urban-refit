            ...
            <section>
              ...
              <div className="grid md:grid-cols-3 gap-8 mt-8">
                <div className="space-y-3">
                  ...
                  <p className="text-muted-foreground">Garments given a second life</p>
                </div>
                <div className="space-y-3">
                  <div className="text-4xl font-bold text-primary">0</div>
                  <p className="text-muted-foreground">Pounds of waste diverted from landfills</p>
                </div>
                <div className="space-y-3">
                  <div className="text-4xl font-bold text-primary">0</div>
            ...
            <section>
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-primary pl-6 space-y-2">
                  <h3 className="text-xl font-semibold text-foreground">Shop Secondhand</h3>
                  <p className="text-muted-foreground">
                    Every purchase extends the life of quality clothing and reduces demand for new production.
                  </p>
                </div>
                <div className="border-l-4 border-primary pl-6 space-y-2">
                  <h3 className="text-xl font-semibold text-foreground">Support Local Thrift Stores</h3>
                  <p className="text-muted-foreground">
                    By shopping with Urban Refit, you support the thrift stores that make our collection possible.
                  </p>
                </div>
                <div className="border-l-4 border-primary pl-6 space-y-2">
                  <h3 className="text-xl font-semibold text-foreground">Donate Quality Clothing</h3>
                  <p className="text-muted-foreground">

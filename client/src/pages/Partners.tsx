            ...
            <section>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  <h3 className="text-xl font-semibold text-foreground">Revenue Share</h3>
                  <p className="text-muted-foreground">
                    Receive 10% of every sale price for garments sourced from your store.
                  </p>
                </div>
                <div className="space-y-3">
                  <h3 className="text-xl font-semibold text-foreground">Brand Visibility</h3>
                  <p className="text-muted-foreground">
                    Your store is featured on our platform and recognized for supporting sustainable fashion.
                  </p>
                </div>
                <div className="space-y-3">
                  <h3 className="text-xl font-semibold text-foreground">Inventory Support</h3>
                  <p className="text-muted-foreground">

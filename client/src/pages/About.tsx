        ...
        <div className="container max-w-4xl py-16 md:py-24">
          <div className="space-y-12">
            ...
            <section className="border-l-4 border-foreground pl-6">
              <p className="text-2xl font-serif text-foreground leading-relaxed mb-4">
            ...
            <section className="pt-8 border-t border-border">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="space-y-3">
                  <h3 className="text-xl font-semibold text-foreground">No Waste</h3>
                ...
                <div className="space-y-3">
                  <h3 className="text-xl font-semibold text-foreground">Real Quality</h3>
                  <p className="text-muted-foreground">
